...
- CLEAN MATH NOTATION: use standard, readable notation that renders correctly. You MAY use degree °, superscripts (x², Ni²⁺), subscripts (H₂O), Greek letters (Δ, π, θ, λ, μ), and ± ≤ ≥ ≠ ×. Write proper chemistry/physics: ΔG, E°cell, Kc, Ecell, Ni²⁺ — NOT mangled spelled-out forms like "DeltaG", "E degcell", or "E degree cell". For square roots and reaction arrows use ASCII: "sqrt(...)" and "->" (e.g. Ni(s) + 2Ag+ -> Ni2+(aq) + 2Ag(s)). Never output a replacement character (�) or a symbol garbled into a word. Chemical states stay (s), (l), (g), (aq).
