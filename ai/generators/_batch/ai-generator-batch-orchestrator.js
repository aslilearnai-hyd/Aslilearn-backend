...
} from '../../providers/gemini-service.js';

import { generateStructuredContentForAiGenerator, finalizeWorksheetStructuredContent, repairWorksheetBatchDuplicates, ensureWorksheetSectionsComplete, rebuildWorksheetBatchVariant, resolveWorksheetTopicLabel } from '../core/ai-content-engine-service.js';
...
import { enrichStructuredContentWithDiagrams } from '../diagrams/ai-diagram-generation-service.js';
...
} from '../shared/ai-generator-lock-service.js';
...
} from '../shared/ai-generator-content-strategy.js';

import { getBatchSlotMaxAttempts, isAiGeneratorCostSaverEnabled, isAiGeneratorGreatQualityEnabled, shouldEnforceBatchUniquenessRetries, shouldUseFlashForAiGeneratorRun } from '../shared/ai-generator-batch-config.js';
