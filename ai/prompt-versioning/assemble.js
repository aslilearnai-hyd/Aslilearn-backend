...
const FOCI_BY_FAMILY = {
  questions: [
    'NUMERICAL & problem-solving — calculation/formula items with fresh values (no story frame)',
    'CONCEPTUAL — definitions, why/how reasoning, and understanding-check items',
    'APPLICATION — textbook-style applied numericals or short problems (direct stems only)',
    ...
    'MIXED higher-order thinking (HOTS) — multi-step, evaluate, and justify items',
  ],
  explain: [
    'DEFINITION-FIRST — build from precise definitions and core statements outward',
    'MECHANISM — step-by-step process walkthrough with a worked example',
    'COMMON MISCONCEPTIONS — lead with what students get wrong and correct it',
    'EXAM-FOCUSED — high-weightage points, recall facts, and mark-scoring tips',
    'COMPARE / CONTRAST two ideas within the subtopic',
    'FORMULA & UNIT DRILL — quantities, SI units, and numerical practice',
  ],
  plan: [
    ...
    'GROUP DISCUSSION with clear roles and timed turns (no fictional adventure)',
    'TEXTBOOK ACTIVITY style — materials, steps, observation table',
  ],
  reading: [
  ...
  cards: [
    ...
    'APPLICATION — direct worked example or short problem cards',
...
export function buildV2VariantHint({ variantIndex, batchSize, family, angle, scenario, seed } = {}) {
  ...
  return [
    ...
    `${angle ? `Secondary focus: ${angle}.` : ''}`,
    'No question may be a minor reword of a "standard" version or of another variant.',
    'Titles and instructions must stay DIRECT (chapter/subtopic + exam/worksheet wording) — never adventure, market-visit, journey, or role-play themes.',
    'Do NOT use scenario flavour wrappers for uniqueness.',
