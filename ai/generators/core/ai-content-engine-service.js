...
import geminiService, { isTransientGeminiError } from '../../providers/gemini-service.js';
import {
...
import { splitMergedActivityTailSections } from '../../rag/pdf/activity-section-headers.js';
import { buildPdfRagContextFromText } from '../../rag/pdf/pdf-rag-service.js';
import {
  buildCurriculumContextPromptBlock,
  isAssessmentToolSlug,
  isExamScaffoldPaddingAllowed,
} from '../../rag/retrieval/curriculum-context-service.js';
import { validateExamPaperPipeline } from '../../validation/exam-paper-pipeline-validator.js';
import { cleanActivityTitleForStorage } from '../../rag/pdf/activity-title-utils.js';
import {
  resolveStudyGuideDisplayTitle,
  sanitizeStudyGuideTitle,
} from '../../../services/study-guide-title-utils.js';
import {
...
} from '../../repair/ai-generator-section-pad.js';
...
} from '../../shared/sanitize-ai-question-display.js';
import { extractJsonObject } from '../../shared/ai-json-extract.js';
import {
...
} from '../../quality-gates/ai-generator-quality-tier.js';
import {
  buildGeminiResponseSchemaForTool,
  isResponseSchemaEnabled,
} from '../shared/ai-generator-response-schema.js';
import { getAiGeneratorVariantAngle, getAiGeneratorVariantScenario } from '../shared/ai-generator-variant-angles.js';
import {
...
} from '../../quality-gates/ai-generator-quality-gate.js';
import {
...
} from '../../repair/ai-generator-section-repair.js';
import {
  resolvePracticeQaTopicLabel,
  pickPracticeQaBankQuestion,
  getPracticeQaBankFramework,
} from '../shared/practice-qa-topic-bank.js';
import {
...
} from '../../shared/story-passage-subject.js';
import {
  buildPromptEngineRewritePrompt,
  isPromptEngineEnabled,
} from '../../prompt-registry/registry.js';
import {
...
} from '../../rag/pdf/extract/pdf-worksheet-extract.js';
