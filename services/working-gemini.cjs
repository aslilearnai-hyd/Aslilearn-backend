...
class WorkingGeminiService {
  ...
  async initializeGemini() {
    try {
      console.log('🔧 Initializing Gemini API with correct models...');
      
      // Try the correct working model names
      const modelNames = [
...
const workingGeminiService = new WorkingGeminiService();

module.exports = { workingGeminiService };
