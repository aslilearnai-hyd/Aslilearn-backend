...
const PACKS = {
  // --- Family: questions ---
  'worksheet-mcq-generator': { title: 'Worksheet & MCQ Generator', family: 'questions', coreRules: 'A complete printable worksheet sized for a realistic 40-45 minute paper (~27 marks total) — Section A: 5 MCQs, 1 mark each (4 options, one correct); Section B: 5 Fill-in-the-Blanks, 1 mark; Section C: 3 Short Answer, 2 marks; Section D: 2 Application/case-based, 3 marks; Section E: 1 long-answer, 5 marks. That is 16 questions. Do NOT exceed these counts — a paper a class cannot finish in 45 minutes is wrong. Every question must be real, chapter-specific, and distinct (no repeats or trivial rewordings). Add internal choice where the board allows.' },
