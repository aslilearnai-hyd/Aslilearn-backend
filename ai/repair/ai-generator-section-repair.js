...
import { getAiGeneratorGeminiModel } from '../generators/shared/ai-generator-batch-config.js';
import { buildCanonicalFieldsRetryHint } from './ai-generator-section-pad.js';
import { extractJsonObject } from '../shared/ai-json-extract.js';
import { resolvePracticeQaTopicLabel } from '../generators/shared/practice-qa-topic-bank.js';
import { getFactBankHint } from '../generators/shared/subject-topic-fact-bank.js';
import { buildStoryPassageLanguagePromptBlock, buildStoryPassageContentPromptBlock, buildStoryPassageMonolingualOverrideBlock } from '../shared/story-passage-subject.js';
import { buildPromptEngineRepairPrompt, isPromptEngineEnabled } from '../prompt-registry/registry.js';
