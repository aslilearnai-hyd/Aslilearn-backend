...
export default createToolPromptPack({
  ...
  focus: 'Hands-on classroom activities and projects a teacher can run tomorrow with named materials, timed steps, and assessment rubric.',
  ...
  generationRules: [
    'ACTIVITY STRUCTURE:',
    '- title: creative name reflecting the subtopic angle (not just the subtopic label).',
    ...
    '- step_by_step_procedure: numbered steps with duration (e.g. "Step 3 (8 min): Students crush leaf in mortar…").',
    ...
    '- real_life_application: Indian context (farm, kitchen, local industry, festival, weather).',
