...
import { extractCanonicalPdfDocument, canonicalPdfHasExtractableContent } from './extract/pdf-canonical-extract.js';
import {
  classifyPdfContent,
...
} from '../../generators/_formatters/index.js';
import { mapCanonicalPdfToToolBulkItems, postProcessCanonicalBulkItems } from './pdf-canonical-mapper.js';
import { consolidateWorksheetExtractItems } from './extract/pdf-worksheet-extract.js';
import { countExpectedPdfItems } from '../../validation/pdf-extract-validation.js';
import {
  activityPatternExtractIsComplete,
  scoreActivityExtractRow,
} from './extract/pdf-activity-extract.js';
import { extractAndGenerateAllItems, getLastPdfExtractionMeta } from '../../providers/gemini-service.js';
import {
  generateStructuredContentFromPdf,
} from '../../generators/core/ai-content-engine-service.js';
