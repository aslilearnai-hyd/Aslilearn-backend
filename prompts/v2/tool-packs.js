...
const PACKS = {
  // --- Family: questions ---
  'worksheet-mcq-generator': { title: 'Worksheet & MCQ Generator', family: 'questions', coreRules: 'A complete printable worksheet with board-appropriate variety: Section A MCQs (4 options, one correct), B Fill-in-the-Blanks, C Very Short/Short Answer, D Application/case-based. Add internal choice where the board allows. Every question real and chapter-specific.' },
