...
export function buildEducatorSystemPrompt(ctx = {}) {
  ...
  return [
    ...
    '- Use natural transitions and varied sentence length — never fictional adventure framing.',
    ...
    '- Scenario wrappers: "Imagine…", "During a school fair…", "Role-play…", "Design a poster…", "Set the scene…", "Market day adventure…", "Welcome young scientists…".',
    '- Adventure / journey / market-visit titles on worksheets or exam papers.',
